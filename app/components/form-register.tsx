      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-sky-500 to-cyan-500 px-8 py-10 text-white text-center">
            ...
            <p className="text-sky-100 text-sm mt-1">Crea tu cuenta</p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <p className="text-center text-xs text-gray-400 dark:text-slate-500 mt-6">
              ¿Ya tienes cuenta?{" "}
              <a href="/login" className="text-sky-500 hover:text-sky-600 dark:text-sky-400 dark:hover:text-sky-300 font-medium hover:underline transition-colors">
                Inicia sesión
              </a>
            </p>
