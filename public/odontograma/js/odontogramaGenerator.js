...
OdontogramaGenerator.prototype.prepareOdontogramaAdult = function (odontograma,
    ...
    for (var i = 18; i > 10; i--) {
        ...
        image.src = "/odontograma/images/dentadura-sup-" + i + ".png";
    ...
    for (var i = 48; i > 40; i--) {
        ...
        image.src = "/odontograma/images/dentadura-inf-" + i + ".png";
...
spaces, canvas) {
    ...
    for (var i = 61; i < 66; i++) {
        ...
        var image = new Image(); //Se agrego el parentesis para crear un nuevo objeto de tipo Image
